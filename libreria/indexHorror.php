    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <div class="row">
            <?PHP
            $result = mysqli_query($con,"SELECT id_libros, titulo, precio, idioma, anio, nombre, apellido_p, imagen, id_tema FROM libros, autores WHERE libros.id_autor=autores.id_autor AND id_tema=4 ORDER BY titulo");
