    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
          ...
          <div class="row">
            <?PHP
              $result = mysqli_query($con,"SELECT id_libros, titulo, precio, idioma, anio, nombre, apellido_p, imagen FROM libros, autores WHERE libros.id_autor=autores.id_autor ORDER BY titulo");
